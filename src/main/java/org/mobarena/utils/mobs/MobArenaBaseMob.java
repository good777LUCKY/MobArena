...
public abstract class MobArenaBaseMob extends EntityCreature implements EntityAgeable {
    ...
    public MobArenaBaseMob(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    ...
    public boolean targetOption(EntityCreature creature, double distance) {
        if (this instanceof MobArenaMonster) {
    ...
    public boolean entityBaseTick(int tickDiff) {
        ...
        if (this instanceof MobArenaMonster && this.attackDelay < 200) {
            this.attackDelay++;
        }
